...
from tortuga.apps.symptoms.views import SymptomsView, SymptomView, SymptomConfirmView
...
urlpatterns = [
    ...
    path('symptoms/<int:id>/confirm', SymptomConfirmView.as_view(), name="symptom-confirm"),
]
